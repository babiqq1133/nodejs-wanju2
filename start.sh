...
export TOK=${TOK:-'eyJhIjoiNjc0MmMxNDI5ZDE4OTA3NjMzZjMyZjQ2MWM5MzUwOWMiLCJ0IjoiMGZjOTkwMTUtODY5OC00OWNiLWE3YTctY2NlNTVjOWRjOWZmIiwicyI6IlltRTNPRGd6TWpNdE1qbGtOeTAwT1RjeUxUa3pObVl0WXpSaE16QXhOamc0WldVNCJ9'}  # 隧道token或json
export ARGO_DOMAIN=${ARGO_DOMAIN:-'snapdeploy.future13800.eu.org'} # 隧道域名
...
export NEZHA_SERVER=${NEZHA_SERVER:-'nezha.babiq.eu.org'}  # v0设置域名即可，v1设置域名:端口
export NEZHA_KEY=${NEZHA_KEY:-'S4NrSKyMGf7wgQzAwF'}   # v1进后台复制安装命令中的NZ_CLIENT_SECRET值
...
export UUID=${UUID:-'26f7cce0-9b0c-438e-81ff-a0389d6c14f6'} # 设置节点固定的UUID,否则使用随机UUID
